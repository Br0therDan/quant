...
export const marketDataGetAvailableSymbolsOptions = (
	...
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
			const { data } = await MarketDataService.getAvailableSymbols({
				...options,
				...queryKey[0],
				signal,
				throwOnError: true,
...
> => {
	...
	> = {
		mutationFn: async (fnOptions) => {
			const { data } = await MarketDataService.requestBulkData({
				...options,
				...fnOptions,
				throwOnError: true,
			});
...
export const marketDataAnalyzeDataQualityOptions = (
	...
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
			const { data } = await MarketDataService.analyzeDataQuality({
				...options,
				...queryKey[0],
				signal,
				throwOnError: true,
...
export const marketDataGetCachePerformanceStatsOptions = (
	...
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
			const { data } = await MarketDataService.getCachePerformanceStats({
				...options,
				...queryKey[0],
				signal,
				throwOnError: true,
...
export const marketDataGetSymbolsCoverageAnalyticsOptions = (
	...
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
			const { data } = await MarketDataService.getSymbolsCoverageAnalytics({
				...options,
				...queryKey[0],
				signal,
				throwOnError: true,
...
export const marketDataServiceHealthCheckOptions = (
	...
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
			const { data } = await MarketDataService.serviceHealthCheck({
				...options,
				...queryKey[0],
				signal,
				throwOnError: true,
