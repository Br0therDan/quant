...
import type {
  ...
  StrategiesGetStrategiesResponse,
  StrategiesGetStrategyExecutionsResponse,
  StrategiesGetStrategyPerformanceResponse,
  StrategiesGetStrategyResponse,
...
export const healthHealthCheck2ResponseTransformer = async (
  data: any,
): Promise<HealthHealthCheck2Response> => {
...
export const strategiesGetStrategiesResponseTransformer = async (
  data: any,
): Promise<StrategiesGetStrategiesResponse> => {
...
export const strategiesCreateStrategyResponseTransformer = async (
  data: any,
): Promise<StrategiesCreateStrategyResponse> => {
  data = strategyResponseSchemaResponseTransformer(data);
  return data;
};

export const strategiesGetStrategyResponseTransformer = async (
  data: any,
): Promise<StrategiesGetStrategyResponse> => {
  data = strategyResponseSchemaResponseTransformer(data);
  return data;
};

export const strategiesUpdateStrategyResponseTransformer = async (
  data: any,
): Promise<StrategiesUpdateStrategyResponse> => {
  data = strategyResponseSchemaResponseTransformer(data);
  return data;
};

export const strategiesExecuteStrategyResponseTransformer = async (
  data: any,
): Promise<StrategiesExecuteStrategyResponse> => {
...
export const strategiesGetStrategyExecutionsResponseTransformer = async (
  data: any,
): Promise<StrategiesGetStrategyExecutionsResponse> => {
...
export const strategiesGetStrategyPerformanceResponseTransformer = async (
  data: any,
): Promise<StrategiesGetStrategyPerformanceResponse> => {
...
export const templatesGetTemplatesResponseTransformer = async (
  data: any,
): Promise<TemplatesGetTemplatesResponse> => {
...
export const templatesCreateTemplateResponseTransformer = async (
  data: any,
): Promise<TemplatesCreateTemplateResponse> => {
