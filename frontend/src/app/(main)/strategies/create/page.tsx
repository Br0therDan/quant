...
export default function CreateStrategyPage() {
  ...
  const sourceStrategyQuery = useQuery({
    ...useStrategyQuery({ path: { strategy_id: sourceId || "" } }),
    enabled: !!sourceId,
  });

  const sourceStrategy = sourceStrategyQuery.data;
  const isLoadingSource = sourceStrategyQuery.isLoading;
